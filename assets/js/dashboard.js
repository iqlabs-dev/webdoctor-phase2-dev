...
console.log('DASHBOARD JS v3.4-REPORTID-PAYLOAD-FIX');
...
function makeReportId() {
  // Format: WEB-YYYYDDD-RAND5  (DDD = day of year)
  const now = new Date();
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  runBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      // ✅ ALWAYS provide report_id (your function expects it in some deploys)
      ...
      const reportId = scanData.report_id ?? scanData.reportId ?? scanData.reportID ?? report_id;
